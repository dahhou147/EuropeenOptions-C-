...
CalibratedData :: CalibratedData(double rho, double theta, double sigma, double kappa, double drift, double S0,
...
double Calibrator :: log_likelihood(double rho, double theta, double sigma, double kappa, double drift) {
    double sum = 0;
